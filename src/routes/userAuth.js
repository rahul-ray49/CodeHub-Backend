...
authRouter.get('/getProfile',userMiddleware,profileLimiter,getUserProfile);
authRouter.put('/update-profile',userMiddleware,uploadLimiter,upload.single('profileImage'),updateProfile);
authRouter.get('/getProfileForUpdation',userMiddleware,profileLimiter,getUserProfileForUpdation);
